...
I am a fourth-year PhD student in statistics at <a href="https://stat.duke.edu" target="_blank"> Duke University</a>. My research interests include but not limited to Bayesian optimization, Gaussian processes, and reinforcement learning. Before joining Duke, I worked with Professor <a href="http://www.stat.nthu.edu.tw/~ycheng/" target="_blank"> Yu-Jen Cheng </a> and Professor <a href="https://profiles.ucsf.edu/chiung-yu.huang" target="_blank"> Chiung-Yu Huang </a> on improving estimation of the transformation model by leveraging external heterogeneous information.
